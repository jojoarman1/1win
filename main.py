...
def register(call):
    message = (
        "🔷 1. Для начала зарегистрируйтесь на сайте <a href='https://1wwbnd.com/casino/list?open=register'>1WIN(CLICK) </a> ""ДЛЯ СТАБИЛЬНОЙ РАБОТЫ СОЗДАЙТЕ НОВЫЙ АККАУНТ - с секретным промокодом <code>MINES19</code>\n"
...
def send_instruction(call):
    message = (
        ...
        "🟢 1. Пройти регистрацию в букмекерской конторе <a href='https://1wwbnd.com/casino/list?open=register'>1WIN(CLICK) </a> \n"
